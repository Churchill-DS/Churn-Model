...
if st.button('Predict Churn'):
    ...
    # Replace X_train.columns with the actual feature names used during training
    feature_names = ['MONTANT', 'FREQUENCE_RECH', 'REVENUE', 'ARPU_SEGMENT', 'FREQUENCE', 
                     'DATA_VOLUME', 'ON_NET', 'ORANGE', 'TIGO', 'REGULARITY', 
                     'FREQ_TOP_PACK', 'TENURE', 'TOP_PACK', 'REGION', 'MRG', 
                     'DATA_VOLUME_MISSING']  # Add all feature names used during training
